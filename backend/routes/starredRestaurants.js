...
router.get("/:id", (req, res) => {
  ...
  const foundRestaurant = STARRED_RESTAURANTS.find((starredRestaurant) => id === starredRestaurant.id);
...
router.post("/", (req, res) => {
  ...
  const foundRestaurantIsStarred = STARRED_RESTAURANTS.find(restaurant =>
...
router.delete("/:id", (req, res) => {
  ...
  const newStarredList = STARRED_RESTAURANTS.filter(restaurant => 
    restaurant.id !== id);
...
router.put("/:id", (req, res) => {
  ...
  foundRestaurant.comment = comment;
